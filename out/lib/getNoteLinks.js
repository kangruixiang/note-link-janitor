...
function getNoteLinks(tree) {
    ...
    const backlinksInfo = (0, getBacklinksBlock_1.default)(tree);
    ...
    visitParents({ ...tree, children: searchedChildren }, "wikiLink", (node, ancestors) => {
        const closestBlockLevelAncestor = ancestors.reduceRight((result, needle) => result ?? (isBlockContent(needle) ? needle : null), null);
        links.push({
