...
const headingFinder = (0, processor_1.default)().use(() => tree => find(tree, { type: "heading", depth: 1 }) || missingTitleSentinel);
async function readNote(notePath) {
    ...
    const title = remark()
        ...
        .trimEnd();
    return { title, links: (0, getNoteLinks_1.default)(parseTree), parseTree, noteContents };
}
