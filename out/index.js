...
(async () => {
    ...
    const notes = await (0, readAllNotes_1.default)(baseNotePath);
    const linkMap = (0, createLinkMap_1.default)(Object.values(notes));
    // Sort by PageRank
    ...
    await Promise.all(Object.keys(notes).map(async (notePath) => {
        ...
        const newContents = (0, updateBacklinks_1.default)(notes[notePath].parseTree, notes[notePath].noteContents, backlinks
            ? [...backlinks.keys()]
                .map(sourceTitle => ({
                sourceTitle,
